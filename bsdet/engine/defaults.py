...
from bsdet.data import *
from bsdet.modeling import build_model
from bsdet.engine.hooks import EvalHookDeFRCN, SendIterHook
from bsdet.checkpoint import DetectionCheckpointer
from bsdet.solver import build_lr_scheduler, build_optimizer
from bsdet.evaluation import DatasetEvaluator, inference_on_dataset, print_csv_format, verify_results
from bsdet.dataloader import MetadataCatalog, build_detection_test_loader, build_detection_train_loader
...
def default_argument_parser():
    ...
    parser.add_argument("--images-path", default="", help="path to inference images")
    parser.add_argument("--inference-opt", default="show", help="show, save, both")
...
def default_setup(cfg, args):
    ...
    setup_logger(output_dir, distributed_rank=rank, name="bsdet")
...
class DefaultTrainer(SimpleTrainer):
    ...
    def build_model(cls, cfg):
        ...
        It now calls :func:`bsdet.modeling.build_model`.
    ...
    def build_optimizer(cls, cfg, model):
        ...
        It now calls :func:`bsdet.solver.build_optimizer`.
    ...
    def build_lr_scheduler(cls, cfg, optimizer):
        """
        It now calls :func:`bsdet.solver.build_lr_scheduler`.
    ...
    def build_train_loader(cls, cfg):
        ...
        It now calls :func:`bsdet.data.build_detection_train_loader`.
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        It now calls :func:`bsdet.data.build_detection_test_loader`.
        Overwrite it if you'd like a different data loader.
        """
