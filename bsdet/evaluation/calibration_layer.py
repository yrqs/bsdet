...
from bsdet.dataloader import build_detection_test_loader
from bsdet.evaluation.archs import resnet101, resnet50
...
class PrototypicalCalibrationBlock:
    ...
    def build_model(self):
        ...
        if self.cfg.TEST.PCB_MODELTYPE == 'resnet50':
            imagenet_model = resnet50()
        elif self.cfg.TEST.PCB_MODELTYPE == 'resnet':
