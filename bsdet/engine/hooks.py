...
class SendIterHook(HookBase):
    def before_step(self):
        if hasattr(self.trainer.model, 'module'):
            if hasattr(self.trainer.model.module.roi_heads.box_predictor, 'current_iter'):
                self.trainer.model.module.roi_heads.box_predictor.current_iter = self.trainer.iter
                # dist.broadcast(runner.model.module.bbox_head.current_epoch, runner.epoch)
        else:
            if hasattr(self.trainer.model.roi_heads.box_predictor, 'current_iter'):
                self.trainer.model.roi_heads.box_predictor.current_iter = self.trainer.iter